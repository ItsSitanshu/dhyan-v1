    ...
    return (
        ...
        <div className="flex flex-row justify-start w-10/12 h-5/6 bg-stone-950 rounded-3xl">
            ...
            <div className="w-9/12 flex flex-col items-center justify-start pt-16">
                <h1 className="text-foreground font-nue text-3xl">Register an Account</h1>
                <p className="text-foreground/[.5]  text-lg">Complete these easy steps to get started in no time</p>
                <AuthButton/>
                <AuthForm/>
            </div>
            </div>
